...
const Filters = () => {
  ...
  const [inputCategory, setInputCategory] = useState<InputCategory>({
    ...
    priceFilter: { text: "price", value: 3400000 },
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-y-1">
        <h3 className="text-xl mb-2">Ketersediaan</h3>
        <div className="form-control">
          <label className="cursor-pointer flex items-center">
            <input
              ...
              className="checkbox"
            />
            <span className="label-text text-lg ml-2 text-black">Stock tersedia</span>
          </label>
        </div>
      ...
      <div className="divider"></div>
      <div className="flex flex-col gap-y-1">
        <h3 className="text-xl mb-2">Harga</h3>
        <div>
          <input
            type="range"
            min={200000}
          ...
          />
          <span>{`Harga minimal: Rp ${inputCategory.priceFilter.value.toLocaleString('id-ID')}`}</span>
        </div>
      </div>
